...
header:
  teaser: /assets/images/medium/the-best-way-to-improve-remote-desktop-experience-0.png
categories:
  - How-To
tags:
  - tablet
...
![image](/assets/images/medium/the-best-way-to-improve-remote-desktop-experience-0.png)
...
1. Visit the [official PowerToys GitHub page](https://github.com/microsoft/PowerToys/releases).
1. Download the latest `.exe` installer.
1. Install and launch the PowerToys app.
### Step 2: Open Keyboard Manager

1. In PowerToys Settings, navigate to **Keyboard Manager**.
1. Enable “Keyboard Manager” if it’s not already active.
...
1. Click **“Remap a key”**.
1. In the “Physical Key” column, select **Alt (Right)**.
1. In the “Mapped To” column, select **Win (Left)**.
1. Click **OK**, then confirm the remapping.

---

### Step 4: Remap Ctrl + Backspace to Delete

1. Go back to the **Keyboard Manager** section.
1. This time, click **“Remap a shortcut”**.
1. In the “Shortcut” column, press **Ctrl + Backspace**.
1. In the “Mapped To” column, select **Delete**.
1. Click **OK** to save.
