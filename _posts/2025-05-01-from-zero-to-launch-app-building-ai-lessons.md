...
Embarking on an app creation journey taught me much more than just coding. It became a window into the evolving partnership between human…
...
🔗 **Explore the GitHub Repo:** https://github.com/MLT-solutions/MLT-stock-idea-assistant[https://github.com/MLT-solutions/MLT-stock-idea-assistant](https://github.com/MLT-solutions/MLT-stock-idea-assistant)
...
**Also on this blog:**
- [The Brutal Reality of Going Indie](/brutal-reality-of-going-indie-ios-android-web-windows/) — what happens after launch: the real friction of shipping to iOS, Android, Web, and Windows
- [App Creation with Gemini 2.5](/app-creation-with-gemini-2-5-noob-perspective/) — using Gemini instead of ChatGPT for building apps: a comparison
- [AI Agent Writes Code at 1,200 WPM](/ai-agent-write-code-1200-wpm-vibe-coding/) — the vibe coding workflow that takes AI-assisted development even further
